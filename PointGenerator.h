...
void createShellPoints(double clusterScale, int numBodies, std::vector<double3> & PointCoords) {
...
void createRandomPoints(double clusterScale, double velocityScale, int numBodies,    std::vector<double3> & PointCoords) {
...
void createGridPoints(int width, int height, std::vector<double3> & PointCoords) {
